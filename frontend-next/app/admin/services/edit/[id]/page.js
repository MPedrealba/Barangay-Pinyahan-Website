    ...
    const fetchService = async () => {
      try {
        ...
        if (res.ok) {
          ...
          setRequirements(parseArray(s.requirements).length > 0 ? parseArray(s.requirements) : ['']);
          setProcedure(parseArray(s.procedure || s.steps).length > 0 ? parseArray(s.procedure || s.steps) : ['']);
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="bg-red-500 hover:bg-red-600 text-white px-5 py-1.5 rounded-md text-sm font-medium transition-colors"
            >
              Cancel
            </button>
            <button
              ...
              className="bg-green-600 hover:bg-green-700 text-white px-5 py-1.5 rounded-md text-sm font-medium transition-colors disabled:opacity-60"
            >
