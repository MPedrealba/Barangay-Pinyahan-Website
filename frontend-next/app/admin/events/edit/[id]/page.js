...
export default function EditEventPage({ params }) {
  ...
  if (loading) {
    return <div className="p-10 text-center text-gray-500 font-bold">Loading event details...</div>;
  }
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="px-8 py-5 border-b border-gray-100 flex items-center justify-between bg-gray-50">
          <h2 className="text-[15px] font-black text-[#002B5B] flex items-center gap-2 uppercase tracking-wide">
            <i className="fas fa-edit text-[#0056b3]"></i> EDIT EVENT
          </h2>
          <Link
            href="/admin/events"
            ...
            <div>
              ...
              {!photoPreview && !existingPhotoUrl ? (
                ...
                >
                  ...
                  <span className="text-sm font-bold uppercase tracking-wider">Click to Upload New Photo</span>
                </div>
              ) : photoPreview ? (
                // Show newly selected photo
                <div className="relative inline-block mt-2">
                  <p className="text-xs font-bold text-green-600 mb-2 uppercase tracking-wide">New Photo Selected:</p>
                ...
                // Show existing photo
                <div className="mt-2">
                  <p className="text-xs font-bold text-gray-500 mb-2 uppercase tracking-wide">Current Photo:</p>
                  <img src={existingPhotoUrl} alt="Current Event" className="max-w-md w-full rounded-lg border border-gray-200 shadow-sm mb-4" />
                  <button 
                    type="button"
                    onClick={() => fileInputRef.current?.click()}
                  ...
                  >
                    <i className="fas fa-upload"></i> Upload Replacement Photo
                  </button>
                </div>
              )}
